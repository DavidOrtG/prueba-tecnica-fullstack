...
import { formatCurrency, calculateBalance, exportToCSV } from '../lib/utils';
import { BarChart3, Download, TrendingUp, TrendingDown, DollarSign, Calendar, FileText } from 'lucide-react';
...
export default function Reports() {
  ...
  const handleExportCSV = () => {
    ...
    exportToCSV(csvData, `reporte_transacciones_${new Date().toISOString().split('T')[0]}.csv`);
  };
